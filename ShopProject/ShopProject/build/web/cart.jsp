<%-- 
    Document   : cart
    Created on : Mar 2, 2024, 11:02:49 PM
    Author     : admin
--%>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="cart" class="cart?uId=${sessionScope.uId}"><span class="ti-bag"></span></a></li>
                                <li class="nav-item">
                        ...
                        <table class="table">
                            ...
                            <c:choose>
                                <c:when test="${empty o.items}">
                                    <tr>
                                        <td style="font-size: 20px" colspan="5">There are no products in the cart</td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="d-flex">
                                                            <img class="cart_img" src="${i.product.imagePath}" alt="">
                                                        </div>
                                                ...
                                                <td>
                                                    <h5>$<span>${i.product.price}</span></h5>
                                                </td>
                                                <td>
                                                    <div class="product_count">
                                                        <input type="text" name="qty" id="sst" maxlength="12" value="${i.quantity}" title="Quantity:"/>
                                                        <button onclick="location.href = 'cart?num=1&id=${i.product.productId}&uId=${sessionScope.uId}'" class="increase items-count" type="button"><i class="lnr lnr-chevron-up"></i></button>
                                                        <button onclick="location.href = 'cart?num=-1&id=${i.product.productId}&uId=${sessionScope.uId}'" class="reduced items-count" type="button"><i class="lnr lnr-chevron-down"></i></button>
                                                    </div>
                                                </td>
                                                <td>
                                                    <form action="cart" method="post">
                                                        <button type="submit" class="btn_re">Remove</button>
                            ...
                            <tr>
                                ...
                                <c:forEach items="${o.items}" var="i">
                                    <c:set var="subtotal" value="${i.quantity * i.product.price}"/>
