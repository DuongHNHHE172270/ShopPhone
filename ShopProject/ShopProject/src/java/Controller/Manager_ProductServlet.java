...
public class Manager_ProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Manager_ProductServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Manager_ProductServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int totalP = dbp.getTotalProduct();
        ...
        if (search != null && !search.isEmpty()) {
            products = dbp.searchByName(search, indexPage);            
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int numberPage = dbp.getNumberPageSearch(search);
        String index = request.getParameter("indexPage");
        int totalP = dbp.getTotalSearch(search);
