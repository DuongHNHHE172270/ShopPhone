...
public class Insert_ProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Insert_ProductServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Insert_ProductServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        if (action != null && action.equals("update")) {
            if (comfirm != null && comfirm.equals("true")) {
                if (pName != null && !pName.isEmpty()
                    ...
                    dbp.insertProduct(pName, pImg, productPrice, productOPrice, pdescrip, productCaId);
                }
            }
        }
