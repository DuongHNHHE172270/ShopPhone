<%-- 
    ...
    Created on : Mar 2, 2024, 11:10:50 PM
    Author     : admin
--%>
                ...
                <div class="row s_product_inner">
                    <div class="col-lg-6">
                        <div class="s_Product_carousel">
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${requestScope.p.imagePath}" alt="">
                            </div>
                            <div class="single-prd-item">
                                <img class="img-fluid" src="${requestScope.p.imagePath}" alt="">
                            </div>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="s_product_text">
                            <h3>${requestScope.p.productName}</h3>
                            <h2>$<span>${requestScope.p.originalPrice}</span></h2>
                            <ul class="list">
                                <li><a class="active" href="#"><span>Category</span> : ${requestScope.p.categoryId.categoryName}</a></li>
                                <li><a href="#"><span>Availibility</span> : In Stock</a></li>
                                <li><a href="#"><span>Count</span> : ${requestScope.p.viewCount}</a></li>
                            </ul>
                            <p>${requestScope.p.description}</p>
                            
                            <div class="card_area d-flex align-items-center">
                                <a style="margin-bottom: 30px" class="primary-btn" href="home">Back to home</a>
                            </div>
                        </div>
                    </div>
                </div>
